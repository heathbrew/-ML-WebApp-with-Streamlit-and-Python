...
def main():
    ...
    def plot_metrics(metrics_list,y_test,y_pred,class_names,):
        ...
        if 'Confusion Matrix' in metrics_list:
            ...
            skplt.metrics.plot_confusion_matrix(y_test, y_pred, normalize=True,title="Mushroom Confusion Matrix")
        ...
        if 'Precision-Recall Curve' in metrics_list:
            ...
            display = PrecisionRecallDisplay.from_estimator(model, x_test, y_test, name="LinearSVC")
            st.set_option('deprecation.showPyplotGlobalUse', False)
            st.pyplot()
